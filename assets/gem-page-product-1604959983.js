...
jQuery(function() {
  ...
  $module.gfV3ProductDesc();
          ...
          jQuery(function() {
  var $module = jQuery('#m-1604960219303').children('.module');
  $module.gfV3Product();
}); 
      
          jQuery(function() {
  var $module = jQuery('#m-1604960219303-1').children('.module');
});
      
          jQuery(function() {
        var $module = jQuery('#m-1604960219303-2').children('.module');
        $module.gfV3ProductPrice({
            displayCurrency: true
        });
    });
          ...
          jQuery(function() {
    var $module = jQuery('#m-1604960219303-0').children('.module');
    var effect = $module.attr('data-effect');
    $module.gfV3ProductImage({
        'effect': effect
    })
          ...
          jQuery(function() {
  var $module = jQuery('#m-1604960219365').children('.module');
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
...
jQuery(function() {
  var $module = jQuery('#m-1604960454529').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
}); 
    
          jQuery(function() {
  var $module = jQuery('#m-1604960219357').children('.module');
  $module.gfV3ProductDesc();
});
...
jQuery(function() {
  ...
  $module.gfV3ProductDesc();
          ...
          jQuery(function() {
  var $module = jQuery('#m-1604960267132').children('.module');
  $module.gfV3Product();
}); 
      
          jQuery(function() {
  var $module = jQuery('#m-1604960267132-1').children('.module');
});
      
          jQuery(function() {
        var $module = jQuery('#m-1604960267132-2').children('.module');
        $module.gfV3ProductPrice({
            displayCurrency: true
        });
    });
          ...
          jQuery(function() {
    var $module = jQuery('#m-1604960267132-0').children('.module');
    var effect = $module.attr('data-effect');
    $module.gfV3ProductImage({
        'effect': effect
    })
...
jQuery(function() {
    var $module = jQuery('#m-1604960748336').children('.module');
    var style = $module.attr('data-style');
    var updatePrice = $module.attr('data-updateprice');
    ...
    $module.gfV3ProductQuantity({
        ...
        'updatePrice': updatePrice
          ...
          jQuery(function() {
  var $module = jQuery('#m-1604960267097').children('.module');
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
...
jQuery(function() {
  var $module = jQuery('#m-1604960267208').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
}); 
    
          jQuery(function() {
  var $module = jQuery('#m-1604960267136').children('.module');
  $module.gfV3ProductDesc();
});
      
    
          jQuery(function() {
  var $module = jQuery('#m-1604961129747').children('.module');
  $module.gfV3Product();
}); 
      
          jQuery(function() {
  var $module = jQuery('#m-1604961129747-1').children('.module');
});
      
          jQuery(function() {
        var $module = jQuery('#m-1604961129747-2').children('.module');
        $module.gfV3ProductPrice({
            displayCurrency: true
        });
    });
          ...
          jQuery(function() {
    var $module = jQuery('#m-1604961129747-0').children('.module');
    var effect = $module.attr('data-effect');
    $module.gfV3ProductImage({
        'effect': effect
    })
...
jQuery(function() {
    var $module = jQuery('#m-1604961129667').children('.module');
    var style = $module.attr('data-style');
    var updatePrice = $module.attr('data-updateprice');
    ...
    $module.gfV3ProductQuantity({
        ...
        'updatePrice': updatePrice
          ...
          jQuery(function() {
  var $module = jQuery('#m-1604961129712').children('.module');
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
...
jQuery(function() {
  var $module = jQuery('#m-1604961129769').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
}); 
    
          jQuery(function() {
  var $module = jQuery('#m-1604961129784').children('.module');
  $module.gfV3ProductDesc();
});
