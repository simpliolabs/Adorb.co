...
jQuery(function() {
  ...
  $module.gfV3ProductDesc();
          ...
          jQuery(function() {
  var $module = jQuery('#m-1614470116845').children('.module');
  $module.gfV3Product();
}); 
      
          jQuery(function() {
  var $module = jQuery('#m-1614470116845-1').children('.module');
});
      
          jQuery(function() {
        var $module = jQuery('#m-1614470116845-2').children('.module');
        $module.gfV3ProductPrice({
            displayCurrency: true
        });
    });
          ...
          jQuery(function() {
    var $module = jQuery('#m-1614470116845-0').children('.module');
    var effect = $module.attr('data-effect');
    $module.gfV3ProductImage({
        'effect': effect
    })
          ...
          jQuery(function() {
  var $module = jQuery('#m-1614470116756').children('.module');
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
...
(function( jQuery ){
  var $module = jQuery('#m-1614912672358').children('.module');
  var style = $module.attr('data-style');
  ...
  $module.gfV3ProductQuantity({
    ...
    'updatePrice': updatePrice
          ...
          jQuery(function() {
  var $module = jQuery('#m-1614470116845-3').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
}); 
      
          jQuery(function() {
  var $module = jQuery('#m-1614470116897').children('.module');
  $module.gfV3ProductDesc();
});
