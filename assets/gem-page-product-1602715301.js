...
jQuery(function() {
  ...
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
          ...
          jQuery(function() {
  var $module = jQuery('#m-1602715573574-child5').children('.module');
  $module.gfV3Product();
}); 
      
          jQuery(function() {
  var $module = jQuery('#m-1602715573574-child5-4').children('.module');
});
      
          jQuery(function() {
        var $module = jQuery('#m-1602715573574-child5-5').children('.module');
        $module.gfV3ProductPrice({
            displayCurrency: true
        });
    });
          ...
          jQuery(function() {
    var $module = jQuery('#m-1602715573574-child5-0').children('.module');
    var effect = $module.attr('data-effect');
    $module.gfV3ProductImage({
        'effect': effect
    })
...
jQuery(function() {
  var $module = jQuery('#m-1602715573574-child5-6').children('.module');
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  ...
  $module.gfV3ProductVariants({
    ...
    onVariantSelected: function(variant, $select) {}
          ...
          jQuery(function() {
  var $module = jQuery('#m-1602715573574-child5-3').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
}); 
      
          jQuery(function() {
  var $module = jQuery('#m-1602715573574-child6').children('.module');
  $module.gfV3Product();
}); 
      
          jQuery(function() {
  var $module = jQuery('#m-1602715573574-child6-4').children('.module');
});
      
          jQuery(function() {
        var $module = jQuery('#m-1602715573574-child6-5').children('.module');
        $module.gfV3ProductPrice({
            displayCurrency: true
        });
    });
          ...
          jQuery(function() {
    var $module = jQuery('#m-1602715573574-child6-0').children('.module');
    var effect = $module.attr('data-effect');
    $module.gfV3ProductImage({
        'effect': effect
    })
...
jQuery(function() {
  var $module = jQuery('#m-1602715573574-child6-6').children('.module');
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  ...
  $module.gfV3ProductVariants({
    ...
    onVariantSelected: function(variant, $select) {}
          ...
          jQuery(function() {
  var $module = jQuery('#m-1602715573574-child6-3').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
}); 
