...
function reloadAdvertisementWidget() {
    ...
    if(apply_discount == true) {
      ...
      $('.icartCheckoutBtnGroup').append('<button type="button" name="icartCheckoutDump" class="icart-button-radius icart-btn-large icart-chk-btn icart-btn-color icart-align-bottom" style="color: rgb(255, 255, 255); background-color: rgb(79, 204, 58); border-color: rgb(79, 204, 58); border-radius: 0px; display: none;">CHECKOUT   :   →</button>')
