...
$(document).ready(function(){
  ...
  _html += '<div class="cart__sidebar border membership_html_block">';
    ...
    _html += '<div data-v-12407f70="" class="membership-bottom">';
      _html += '<ul><li><a data-v-12407f70="" href="javascript:void(0)" class="add_membership btn btn--full button button--primary" id="add-membership-product-in-cart">Add Membership</a></li></ul>';
