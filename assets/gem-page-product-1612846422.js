...
jQuery(function() {
    var $module = jQuery('#m-1612841421481').children('.module');
    var style = $module.attr('data-style');
    var updatePrice = $module.attr('data-updateprice');
    ...
    $module.gfV3ProductQuantity({
        ...
        'updatePrice': updatePrice
          ...
          jQuery(function() {
  var $module = jQuery('#m-1612841432975').children('.module');
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  ...
  $module.gfV3ProductVariants({
    ...
    onVariantSelected: function(variant, $select) {}
          ...
          jQuery(function() {
  var $module = jQuery('#m-1612841445456').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
}); 
...
jQuery(function() {
    var $module = jQuery('#m-1612841468157').children('.module');
    var style = $module.attr('data-style');
    var updatePrice = $module.attr('data-updateprice');
    ...
    $module.gfV3ProductQuantity({
        ...
        'updatePrice': updatePrice
          ...
          jQuery(function() {
  var $module = jQuery('#m-1612841477785').children('.module');
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  ...
  $module.gfV3ProductVariants({
    ...
    onVariantSelected: function(variant, $select) {}
          ...
          jQuery(function() {
  var $module = jQuery('#m-1612841486041').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
}); 
  ...
  $module.gfV3ProductDesc();
          ...
          jQuery(function() {
  var $module = jQuery('#m-1610678619659').children('.module');
  $module.gfV3Product();
}); 
      
          jQuery(function() {
  var $module = jQuery('#m-1610678619659-1').children('.module');
});
      
          jQuery(function() {
        var $module = jQuery('#m-1610678619659-2').children('.module');
        $module.gfV3ProductPrice({
            displayCurrency: true
        });
    });
          ...
          jQuery(function() {
    var $module = jQuery('#m-1610678619659-0').children('.module');
    var effect = $module.attr('data-effect');
    $module.gfV3ProductImage({
        'effect': effect
    })
...
jQuery(function() {
    var $module = jQuery('#m-1612841507751').children('.module');
    var style = $module.attr('data-style');
    var updatePrice = $module.attr('data-updateprice');
    ...
    $module.gfV3ProductQuantity({
        ...
        'updatePrice': updatePrice
          ...
          jQuery(function() {
  var $module = jQuery('#m-1612841516324').children('.module');
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  ...
  $module.gfV3ProductVariants({
    ...
    onVariantSelected: function(variant, $select) {}
          ...
          jQuery(function() {
  var $module = jQuery('#m-1612841528520').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
}); 
      
          jQuery(function() {
  var $module = jQuery('#m-1610678619601').children('.module');
  $module.gfV3ProductDesc();
});
