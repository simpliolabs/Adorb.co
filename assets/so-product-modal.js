if(!customElements.get('so-product-modal')){customElements.define('so-product-modal',class SoProductModal extends SoModalDialog{constructor(){super()}
hide(){super.hide()}
