...
jQuery(function() {
  ...
  $module.gfV3ProductDesc();
          ...
          jQuery(function() {
  var $module = jQuery('#m-1605234535265').children('.module');
  $module.gfV3Product();
}); 
      
          jQuery(function() {
  var $module = jQuery('#m-1605234535265-1').children('.module');
});
      
          jQuery(function() {
        var $module = jQuery('#m-1605234535265-2').children('.module');
        $module.gfV3ProductPrice({
            displayCurrency: true
        });
    });
          ...
          jQuery(function() {
    var $module = jQuery('#m-1605234535265-0').children('.module');
    var effect = $module.attr('data-effect');
    $module.gfV3ProductImage({
        'effect': effect
    })
          ...
          jQuery(function() {
  var $module = jQuery('#m-1605234535282').children('.module');
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
...
jQuery(function() {
  var $module = jQuery('#m-1605234535251').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
}); 
    
          jQuery(function() {
  var $module = jQuery('#m-1605234535243').children('.module');
  $module.gfV3ProductDesc();
});
